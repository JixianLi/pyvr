...
def test_shader_files_exist():
    ...
    assert os.path.exists(fragment_shader), f"Fragment shader not found at {fragment_shader}"
...
def test_shader_path_resolution():
    ...
    assert os.path.exists(vertex_shader_path), "Volume renderer cannot resolve vertex shader path"
    assert os.path.exists(fragment_shader_path), "Volume renderer cannot resolve fragment shader path"
