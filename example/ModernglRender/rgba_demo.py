...
camera_positions = [
    ...
    {"azimuth": np.pi/2, "elevation": np.pi/6, "roll": 0, "distance": 3, "title": "Side View"},
    {"azimuth": np.pi, "elevation": 0, "roll": 0, "distance": 3, "title": "Back View"},
    {"azimuth": 3*np.pi/2, "elevation": -np.pi/6, "roll": 0, "distance": 3, "title": "Other Side"},
]
...
fig.text(0.5, 0.02, 'PyVR v0.2.2 introduces combined RGBA transfer function textures for improved performance', 
